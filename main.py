...
def main():
    ...
    parser.add_argument("command", nargs='?',  default="scheduler")
    ...
    match command:
        ...
        case "generate":
            ...
            utils.create_and_save_post(dry_run=True)
        ...
        case "web":
            log.info("Starting Web only")
            run_preflight()
            run_flask()

        case "scheduler":
            log.info("Starting Scheduler and Web from main")
            run_preflight()
            start()
